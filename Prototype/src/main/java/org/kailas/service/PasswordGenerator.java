...
public class PasswordGenerator extends Dictionary {
    ...
    private static BigInteger calcEntropy(User user) throws NoSuchAlgorithmException, InvalidKeyException {
        ...
        String domainKey = getSiteKey(masterKey,user.getProfile().getDomain(),user.getProfile().getRevision());
    ...
    private static List<String> getConfiguredRules(PasswordProfile passwordProfile) {
    ...
    private static String renderPassword(BigInteger entropy, PasswordProfile passwordProfile) throws ExcludeAllCharsAvailable {
        List<String> rules = getConfiguredRules(passwordProfile);
        String excludedChars = passwordProfile.getExlude() ; //optional string to exclude
    ...
    public static String generate_password(User user) throws NoSuchAlgorithmException, ExcludeAllCharsAvailable, InvalidKeyException {
        BigInteger entropy = calcEntropy(user);
        return renderPassword(entropy, user.getProfile());
    }
